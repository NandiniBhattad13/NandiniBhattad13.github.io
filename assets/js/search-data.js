...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "Here are some projects on machine learning and statistics that I have worked on!",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-bayesian-inference-based-on-expected-evaluation",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-study-of-non-parametric-regression",
          title: 'Study of Non-Parametric Regression',
          description: "",
          section: "Projects",handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%62%68%61%74%74%61%64%6E%61%6E%64%69%6E%69%31%33@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/NandiniBhattad13", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/nandini-bhattad-523824225", "_blank");
        },
      },{
      id: 'light-theme',
